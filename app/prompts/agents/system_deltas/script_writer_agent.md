...
For long_form 450s, do not stop around 60-300 seconds; expand each planned section until narration word count is at least task_payload.script_duration_contract.minimum_word_count.
...
Write concise narration only in artifact.sentences[].text. Do not include essay expansion, long generic examples, repeated summaries, or implementation tutorial padding.
