...
class ProductionWorkflowState(StrEnum):
    ...
    PAUSED_AFTER_NATIVE_RENDER = "PAUSED_AFTER_NATIVE_RENDER"
    FINAL_REVIEW_READY = "FINAL_REVIEW_READY"
    PRIVATE_STAGING_PENDING = "PRIVATE_STAGING_PENDING"
    PRIVATE_VERIFIED_AWAITING_PUBLIC = "PRIVATE_VERIFIED_AWAITING_PUBLIC"
