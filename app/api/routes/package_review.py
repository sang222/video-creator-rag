...
def create_router() -> APIRouter:
    ...
    @router.post("/video-packages/first-scripted", response_model=FirstScriptedVideoPackageRead)
    ...
    @router.post("/video-packages/rehearse-full", response_model=FirstScriptedVideoPackageRead)
    ...
    @router.get("/video-packages/rehearse-full/preflight", response_model=M122SPreflightRead)
    ...
    @router.get("/video-packages/{package_id}", response_model=FirstScriptedVideoPackageRead)
    ...
    @router.get("/video-packages/{package_id}/review", response_model=FirstScriptedVideoPackageReviewRead)
    ...
    @router.get("/video-packages/{package_id}/packaging-handoff", response_model=PackagingHandoffSnapshotRead)
    ...
    @router.get("/video-packages/{package_id}/packaging-review-queue", response_model=PackagingReviewQueueRead)
    ...
    @router.post("/video-packages/{package_id}/packaging-review-queue/build-from-gates", response_model=PackagingReviewQueueRead)
    ...
    @router.post("/video-packages/{package_id}/rerun-packaging-gates", response_model=PackagingGateRerunRecordRead)
    ...
    @router.get("/video-packages/{package_id}/agent-runs", response_model=FirstScriptedVideoPackageAgentRunsRead)
    ...
    @router.get("/video-packages/{package_id}/generation-boundary", response_model=VideoGenerationBoundaryRead)
    ...
    @router.post("/video-packages/{package_id}/upload-task", response_model=HumanUploadTaskLedgerRead)
    ...
    @router.post("/upload-tasks/{task_id}/start", response_model=HumanUploadTaskLedgerRead)
    ...
    @router.post("/upload-tasks/{task_id}/backfill-uploaded-video", response_model=BackfillUploadedVideoResult)
