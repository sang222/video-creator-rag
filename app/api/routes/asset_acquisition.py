    ...
    def acquisition_plan(package_id: str):
        ...
        return {
            ...
            "request_counts": {
                ...
                "pexels": payload["pexels_request_count"],
                "luma": payload["luma_request_count"],
            },
            "unresolved_requests": payload["unresolved_request_count"],
            "planned_provider_intent": {"pexels": payload["pexels_request_count"], "luma": payload["luma_request_count"]},
