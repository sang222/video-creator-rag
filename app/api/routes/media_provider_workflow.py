...
def create_router() -> APIRouter:
    ...
    @router.get("/media-provider-roles", response_model=list[MediaProviderRoleProfileRead])
    ...
    @router.get("/media-provider-roles/{provider_key}", response_model=MediaProviderRoleProfileRead)
    ...
    @router.get("/media-provider-capabilities", response_model=list[ProviderCapabilityMatrixEntryRead])
    ...
    @router.get("/media-provider-capabilities/{provider_key}", response_model=list[ProviderCapabilityMatrixEntryRead])
    ...
    @router.post("/media-render-routing/decide", response_model=MediaRenderRoutingDecisionRead)
    ...
    @router.get("/media-render-routing/decisions/{decision_id}", response_model=MediaRenderRoutingDecisionRead)
    ...
    @router.post("/video-projects/{video_project_id}/long-form-render-package", response_model=LongFormRenderPackageRead)
    ...
    @router.get("/long-form-render-packages/{package_id}", response_model=LongFormRenderPackageRead)
    ...
    @router.post("/short-candidates/{short_candidate_id}/short-render-package", response_model=ShortRenderPackageRead)
    ...
    @router.get("/short-render-packages/{package_id}", response_model=ShortRenderPackageRead)
    ...
    @router.post("/video-projects/{video_project_id}/ai-hero-assets/plan", response_model=AIHeroAssetRead)
    ...
    @router.post("/ai-hero-assets/{asset_id}/generate", response_model=AIHeroGenerationJobRead)
    ...
    @router.post("/video-projects/{video_project_id}/thumbnail-variants/plan", response_model=list[ThumbnailVariantRead])
    ...
    @router.get("/media-provider-budgets", response_model=list[MediaProviderBudgetPolicyRead])
    ...
    @router.get("/media-provider-budgets/snapshot", response_model=list[MediaProviderBudgetSnapshotRead])
    ...
    @router.post("/media-provider-gates/capability/check", response_model=ProviderCapabilityGateRead)
    ...
    @router.post("/media-provider-gates/license/check", response_model=LicenseEvidenceGateRead)
    ...
    @router.post("/media-provider-gates/budget/check", response_model=MediaProviderBudgetGateRead)
    ...
    @router.post("/media-provider-gates/reused-content/check", response_model=ReusedContentRiskGateRead)
