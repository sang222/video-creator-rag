...
class ConfigRegistryService:
    ...
    def _validate_items(self, document: CatalogDocument) -> None:
        validators = {
            ...
            "cloud_media_storage_provider_catalog": SimpleKeyCatalogItem,
            "cloud_media_type_catalog": SimpleKeyCatalogItem,
            "cloud_media_upload_status_catalog": SimpleKeyCatalogItem,
            "cloud_media_verification_status_catalog": SimpleKeyCatalogItem,
            "local_cleanup_status_catalog": SimpleKeyCatalogItem,
            "media_offload_job_state_catalog": SimpleKeyCatalogItem,
            "google_drive_connection_state_catalog": SimpleKeyCatalogItem,
            "google_drive_oauth_session_status_catalog": SimpleKeyCatalogItem,
            "m10_5_reason_code_catalog": ReasonCodeItem,
            "dashboard_language_catalog": SimpleKeyCatalogItem,
            "operator_user_role_catalog": SimpleKeyCatalogItem,
            "operator_user_status_catalog": SimpleKeyCatalogItem,
            "auth_session_status_catalog": SimpleKeyCatalogItem,
            "translation_mode_catalog": SimpleKeyCatalogItem,
            "localization_translation_status_catalog": SimpleKeyCatalogItem,
            "localization_human_review_status_catalog": SimpleKeyCatalogItem,
            "localization_readiness_result_catalog": SimpleKeyCatalogItem,
            "publish_timing_source_catalog": SimpleKeyCatalogItem,
            "publish_timing_confidence_catalog": SimpleKeyCatalogItem,
            "m11_1_reason_code_catalog": ReasonCodeItem,
