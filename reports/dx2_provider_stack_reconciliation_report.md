...
- `AI_HERO_GENERATION`, `AI_METAPHOR_GENERATION` route tới `google_veo`.
...
- Google Veo duration lock: allowed `8`, max `8s`; không mở `10s`.
...
- `pytest tests/test_m2_provider_wiring_without_paid_calls.py tests/test_r3d8_production_cost_firewall_provider_boundary.py tests/qualification/test_m10_4_google_veo.py tests/qualification/test_m12_provider_readiness.py tests/test_app_health.py -q` → 42 passed.
