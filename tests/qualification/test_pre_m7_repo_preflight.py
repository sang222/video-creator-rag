...
ALLOWED_QUALIFICATION_DIRTY_PREFIXES = (
    ...
    "config/ai_hero_asset_state_catalog.yaml",
    ...
    "config/m10_2_reason_code_catalog.yaml",
    "config/media_budget_enforcement_catalog.yaml",
    "config/media_budget_state_catalog.yaml",
    "config/media_job_type_catalog.yaml",
    "config/media_provider_recommendation_catalog.yaml",
    "config/media_provider_type_catalog.yaml",
