...
ALLOWED_QUALIFICATION_DIRTY_PREFIXES = (
    ...
    "app/contracts/m10_3.py",
    "app/contracts/m10_5.py",
    "app/contracts/m11.py",
    "app/contracts/m11_1.py",
    "app/contracts/m12.py",
    "app/core/config.py",
    ...
    "app/db/models/m10_3.py",
    "app/db/models/m10_5.py",
    "app/db/models/m11.py",
    "app/db/models/m11_1.py",
    "app/db/models/m12.py",
    "app/main.py",
    "app/services/__init__.py",
    "app/services/channel_workspace.py",
    ...
    "alembic/versions/0013_m10_2_provider_routing.py",
    "alembic/versions/0014_m10_3_youtube_follow.py",
    "alembic/versions/0015_m10_5_google_drive_media_offload.py",
    "alembic/versions/0016_m11_operator_dashboard.py",
    ...
    "config/cloud_media_upload_status_catalog.yaml",
    "config/cloud_media_verification_status_catalog.yaml",
    "config/google_drive_connection_state_catalog.yaml",
    "config/google_drive_oauth_session_status_catalog.yaml",
    "config/dashboard_language_catalog.yaml",
    "config/operator_user_role_catalog.yaml",
    "config/operator_user_status_catalog.yaml",
    "config/auth_session_status_catalog.yaml",
    "config/translation_mode_catalog.yaml",
    "config/localization_translation_status_catalog.yaml",
    "config/localization_human_review_status_catalog.yaml",
    "config/localization_readiness_result_catalog.yaml",
    "config/publish_timing_source_catalog.yaml",
    "config/publish_timing_confidence_catalog.yaml",
    "config/m11_1_reason_code_catalog.yaml",
    "config/local_cleanup_status_catalog.yaml",
    "config/media_offload_job_state_catalog.yaml",
    ...
    "config/m10_3_reason_code_catalog.yaml",
    "config/m10_5_reason_code_catalog.yaml",
    ...
    "config/youtube_follow_sync_status_catalog.yaml",
    "config/youtube_metric_authority_catalog.yaml",
    "config/youtube_metric_availability_catalog.yaml",
    "config/youtube_sync_run_state_catalog.yaml",
    "config/youtube_sync_source_catalog.yaml",
